...
class FinanceController:
   ...
   def refreshAllUi(self):
       ...
       self.updateTotalAndCompare()
       self.processRightTable()
   ...
   # =====================================================================
   def updateTotalAndCompare(self):
   ...
   def processRightTable(self):
       ...
       self.drawRightTable(current_list)


   def drawRightTable(self, data_list):
