...
#TAB 3
       self.pushButtonAddExpense.clicked.connect(self.finance_controller.process_add)
       self.pushButton_addincome.clicked.connect(self.finance_controller.processAddIncome)
       self.pushButtonsearch_3.clicked.connect(self.finance_controller.processRightTable)
       self.comboBoxsapxep_2.currentIndexChanged.connect(self.finance_controller.processRightTable)
       self.comboBoxloc_2.currentIndexChanged.connect(self.finance_controller.processRightTable)
...
# OVERSIGHT & INSIGHTS
       ...
       self.stackedWidget.currentChanged.connect(self.insight_controller.kiemTraTrangHienTai)
